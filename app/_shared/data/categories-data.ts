...
const getDefaultPrices = (size: string): PaintingProduct["prices"] => {
  // tu peux raffiner par taille plus tard
  return {
    original: 2000,
    printXXL: 400,
    printA3: 60,
...
export const paintings: PaintingProduct[] = artworks.map((artwork) => {
